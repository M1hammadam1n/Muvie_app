...
class MovieTopRated extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (_) => TopMovieListBloc(const TopMovieListState.inital())
        ..add(TopMovieListEventLoadReset())
        ..add(TopMovieListEventLoadNextPage(locale.languageCode)),
...
class _MovieListWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<TopMovieListBloc, TopMovieListState>(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              if (index >= state.movies.length - 1) {
                ...
                context.read<TopMovieListBloc>().add(TopMovieListEventLoadNextPage(locale));
              }
